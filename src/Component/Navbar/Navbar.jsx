    ...
    <div className="container flex items-center justify-between mx-auto my-2 md:px-6">
      ...
      <div className="md:hidden">
        ...
        <nav
          ...
          } fixed top-10 right-0 w-2/4 h-full bg-yellow-500 transition-transform duration-300 ease-in-out md:static md:flex md:w-auto md:h-auto md:bg-transparent md:translate-x-0`}
        id="navitem">
