...
const RegistrationForm = () => {
  ...
  return (
    <div className="p-4">
      ...
      <div className="max-w-lg mx-auto overflow-hidden bg-white rounded-lg shadow-md transition-transform duration-500 ease-in-out transform hover:-translate-y-2">
        <div className="px-8 py-10">
          <form onSubmit={handleSubmit}>
            <div className="mb-6">
              ...
              <input
                className="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline transition-colors duration-300 ease-in-out focus:border-blue-500"
                id="firstName"
                type="text"
