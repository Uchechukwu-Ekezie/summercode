      ...
      <div className="px-4 py-20 mx-auto lg:flex lg:items-center">
        <div className="max-w-xl mx-auto text-center">
          ...
          <p className="mt-4 sm:text-xl/relaxed">
            Dive into the world of backend development and learn how to build and maintain the server-side of web applications. Join us and enhance your programming skills today!
          </p>
